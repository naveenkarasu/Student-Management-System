  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">View your academic performance and grade visualizations.</p>
      </div>
      ...
      {gpa && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card>
            ...
            <CardContent>
              <p className="text-3xl font-bold text-gray-900">{gpa.gpa.toFixed(2)}</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="pb-2">
            ...
            <CardContent>
              <p className="text-3xl font-bold text-gray-900">{gpa.totalCredits}</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium text-gray-600">Total Grade Points</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-3xl font-bold text-gray-900">{gpa.totalGradePoints.toFixed(1)}</p>
            </CardContent>
          </Card>
        </div>
      )}
